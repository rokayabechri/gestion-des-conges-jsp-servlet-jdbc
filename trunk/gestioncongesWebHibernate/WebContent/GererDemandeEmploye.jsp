...
<TABLE BORDER=1>
    ...
    <c:forEach items="${emp.demcong}" var="dem">
    	...
    	<tr>
 		 ...
 		 <fmt:formatDate value="${dem.dateFin}" pattern="dd/MM/yyyy" var="dateFF"/>
			...
			<c:param name="com" value="${dem.comment}" />
			 <c:param name="comhidden" value="faux"/>
	        ...
	        <td><a href='<c:out value="${AccepterURL}" />'>Accepter Conges</a><br/></td>
	        <td><a href='<c:out value="${RefuserURL}" />'>refuser Conges</a><br/></td>
